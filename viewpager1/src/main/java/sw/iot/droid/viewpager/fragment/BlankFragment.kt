package sw.iot.droid.viewpager.fragment
...
class BlankFragment : Fragment() {
    ...
    private fun initView(view: View) {
        val title = view.findViewById<View>(R.id.textView) as TextView
        val imageView = view.findViewById<View>(R.id.imageview) as ImageView
        title.text = param1
        imageView.setImageResource(param2!!)
        if (isAdded && isVisible) {
            onButtonPressed(param1!!)
        }
    }
